...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="conbg">
     ...
     <a href='<%= "News.aspx?CategoryId=2"  %>'>
        ...
        <div class="right">
            <div class="right1">
                <div class="" style="color: #34A9D4; font-weight: bold; font-size: 120%; padding-left: 21px; float: left; margin-top: 5px; width: 100%; background-image: url(../images/icon005.gif); background-repeat: no-repeat; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #d3d3d3; padding-bottom: 7px; background-position: 0px 0px; margin-bottom: 10px;">
                    <span>
                ...
                <asp:Repeater ID="rptNewsContent" runat="server">
                    <ItemTemplate>
                        <div class="d-flex box3">
                            <div class="">
                                <div class="fw-bold" style="background-image: url(../images/icon007.gif); background-repeat: no-repeat; background-position: 1px 3px; padding-left: 10px; color: #34A9D4; font-size: 110%; padding-bottom: 10px;">
                                    <%# Eval("Title") %>
                                </div>
                                <div>
                                    <%# Eval("content") %>
