<%@ Page Title="" Language="C#" MasterPageFile="~/Site-F.Master" AutoEventWireup="true" CodeBehind="YachtsTest1.aspx.cs" Inherits="Yachts.YachtsTest1" %>
                                ...
                                <ItemTemplate>
                                    <li>
                                        <a href='<%# ResolveUrl("~/Uploads/Photos/" + Eval("CarouselImgPath")) %>'>
                                            <img src='<%# ResolveUrl("~/Uploads/Photos/" + Eval("CarouselImgPath")) %>' style="width: 99px; height: 59px;" />
                                        </a>
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
