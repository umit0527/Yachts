<%@ Page Title="" Language="C#" MasterPageFile="~/Site-F.Master" AutoEventWireup="true" CodeBehind="YachtsInterior.aspx.cs" Inherits="Yachts.YachtsInterior" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="/css/homestyle2.css?v=3" rel="stylesheet" type="text/css" />
        <!-- JS Libraries -->
...
<a href="#">
    <asp:Label ID="Model" runat="server" Text="Label" Style="color: rgb(52, 169, 212);"></asp:Label>
</a>
    </div>
    <div class="right">
        <div class="right1">
            <div class="title">
                <span>
                    <asp:Label ID="txtModel" runat="server" Text="Label" Style="color: rgb(52, 169, 212);"></asp:Label></span>
            </div>
            <!--次選單-->
            <div class="menu_y">
                <ul>
            ...
            <!--------------------------------內容開始---------------------------------------------------->
            <div class="box1">
                <asp:Label ID="txtContent" runat="server" Text="Label"><%# Eval("content") %></asp:Label>
            </div>
            <div class="box3">
