<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Yachts.BackEnd.Register" %>
...
<head>
    ...
    <title>Tayana | Register</title>
    <!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="Tayana | Register" />
...
<body class="login-page " style="overflow: hidden !important; background-size: cover; background-position: 50%; background-image: url('https://images.unsplash.com/photo-1497294815431-9365093b7331?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80');">
            ...
            <div class="card-body login-card-body">
                ...
                <form runat="server">
                    <div class="input-group mb-3">
                        <asp:TextBox ID="Name" runat="server" placeholder="Name" class="form-control"></asp:TextBox>
    ...
    Display="Dynamic">
                    ...
                    <div>
                        <asp:Label ID="LabelAdd" Text="帳號已重複" runat="server" CssClass="text-danger" Visible="false" />
                    </div>
                    <asp:RequiredFieldValidator
    ...
    Display="Dynamic">
                    ...
                    <div class="input-group mb-3">
                        <asp:TextBox ID="CheckPassword" runat="server" placeholder="Confirm Password" TextMode="Password" class="form-control"></asp:TextBox>
                        
                        <div class="input-group-text"><span class="bi bi-lock-fill"></span></div>
                    </div><asp:RequiredFieldValidator
                            ID="RequiredFieldValidator4"
                            runat="server"
                            ControlToValidate="CheckPassword"
                    ...
                    <div class="row">
                        ...
                        <div class="input-group my-3 ms-2 border-bottom" style="width: 325px;">
                        </div>
                        <div class="col-12">
                            <div class="d-grid gap-2">
                                <asp:Button ID="btnSignin" runat="server" Text="Sign In" OnClick="btnSignin_Click" class="btn btn-secondary" CausesValidation="false" />
                            </div>
                        </div>
                        <!-- /.col -->
                    </div>
