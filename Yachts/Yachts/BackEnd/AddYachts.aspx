                    ...
                    <div class="row mb-3 align-items-center">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="ModelName" class="fw-bold">YachtsName *</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="ModelNum" class="fw-bold">YachtsNumber *</label>
                                <asp:RequiredFieldValidator
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator
                                    ...
                                    runat="server"
                                    ControlToValidate="rblModelLabel"
                                    ErrorMessage="請選擇標籤"
                                    ForeColor="Red"
                                    Display="Dynamic">
                                </asp:RequiredFieldValidator>
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <asp:PlaceHolder ID="phEdit" runat="server" Visible='<%# Container.ItemIndex == (int)(ViewState["PendingEditIndex"] ?? -1) %>'>
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-append ml-2">
                                                                ...
                                                                <asp:Button ID="btnCancelPending" runat="server" Text="取 消" CommandName="Cancel" CssClass="btn btn-sm btn-secondary ml-1" CausesValidation="false"/>
                                                                <asp:RequiredFieldValidator
                                                                    ID="RequiredFieldValidator1"
                                                                    runat="server"
                                                                    ControlToValidate="txtEditName"
                                                                    ErrorMessage="請輸入欄位名稱"
                                                                    ForeColor="Red"
                                                                    Display="Dynamic">
                                                                </asp:RequiredFieldValidator>
                                                                <asp:RequiredFieldValidator
                                        ...
                                        <asp:Panel ID="pnlInputFields" runat="server" Visible="false" CssClass="mb-3">
                                            ...
                                            <div class="text-right">
                                                <asp:Button ID="btnAddField" runat="server" Text="送 出" OnClick="btnAddNewField_Click" CssClass="btn btn-warning btn-sm" CausesValidation="false" />&nbsp;
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator
                                    ...
                                    runat="server"
                                    ControlToValidate="FUInteriorImg"
                                    ErrorMessage="請新增圖片"
                                    ForeColor="Red"
                                    Display="Dynamic">
                                </asp:RequiredFieldValidator>
