<%@ Page Title="" Language="C#" MasterPageFile="~/Site-F.Master" AutoEventWireup="true" CodeBehind="YachtsLayout.aspx.cs" Inherits="Yachts.YachtsLayout" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $slideshow.find('ul').html($slideshow.find('ul').children().get());
...
<!--------------------------------換圖結束---------------------------------------------------->
    <div class="conbg">
        ...
        <div id="crumb">
            ...
            <a href="<%= "YachtsLayout.aspx?ModelId=" + Request.QueryString["ModelId"] %>">
        ...
        <div class="right">
            <div class="right1">
                <div class="title">
                    <span>
                        <asp:Label ID="txtModel2" runat="server" Text="Label" Style="color: rgb(52, 169, 212);"></asp:Label></span>
                </div>
                <!--次選單-->
                <div class="menu_y">
                    <ul>
...
<li><a class="menu_yli03" href='<%="YachtsSpecification.aspx?ModelId=" + Request.QueryString["ModelId"] %>'>Specification</a></li>
                ...
                <div class="box6">
                    ...
                    <ul>
                        <li>
                            <asp:Image ID="DeckImgPath1" runat="server" Style="max-width: 100%; height: auto;" />
                        </li>
                        <li>
                            <asp:Image ID="DeckImgPath2" runat="server" Style="max-width: 100%; height: auto;" />
                            </li>
                    </ul>
                </div>
                <p class="topbuttom">
